...
from webify import __version__, daemon, state
from webify.config import DEFAULT_PORT, SERVICES_DIR, ensure_dirs
from webify.core import WebifyError, find_free_port
from webify.services import build_service
...
def run_web(host: str = "0.0.0.0", port: int = None):
    ...
    try:
        ...
        raise WebifyError(
            ...
            "Install them with: sudo apt install webify-web"
        )
